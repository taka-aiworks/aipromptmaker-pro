window.DEFAULT_NSFW_DICT = {
  "NSFW": {
    ...
    "outfit": [
      ...
      { "tag": "china_dress",      "ja": "チャイナドレス",        "level": "L1" },
      { "tag": "qipao_slit",       "ja": "スリット入りチャイナドレス", "level": "L2" },
      { "tag": "yukata_r18",       "ja": "浴衣（はだけ仕様）",     "level": "L1" },
      { "tag": "kimono_open",      "ja": "着物（はだけ）",         "level": "L2" },
      { "tag": "hakama_slit",      "ja": "袴（スリット入り）",     "level": "L2" },
      { "tag": "leotard_r18",      "ja": "レオタード（えっち仕様）","level": "L2" },
      { "tag": "idol_dress_r18",   "ja": "アイドルドレス（セクシー）","level": "L1" },
      { "tag": "stewardess_uniform","ja": "スチュワーデス制服",   "level": "L1" },
      { "tag": "military_uniform_r18","ja": "軍服（セクシー仕様）","level": "L2" },
      { "tag": "police_uniform_r18","ja": "ポリス制服（セクシー仕様）","level": "L1" },
      { "tag": "witch_bikini",     "ja": "魔女ビキニ衣装",         "level": "L2" },
      { "tag": "angel_costume",    "ja": "天使コスチューム（えっち仕様）","level": "L1" },
      { "tag": "devil_costume",    "ja": "悪魔コスチューム（えっち仕様）","level": "L1" },
      { "tag": "noble_dress_r18",  "ja": "貴族風ドレス（えっち仕様）", "level": "L2" },
      { "tag": "egyptian_costume", "ja": "エジプト風衣装（セクシー）", "level": "L2" },
      { "tag": "belly_dancer_outfit","ja": "ベリーダンス衣装",    "level": "L2" },
      { "tag": "harem_outfit",     "ja": "ハーレム衣装",           "level": "L2" },
      { "tag": "tribal_outfit",    "ja": "民族衣装（露出多め）",   "level": "L2" },
      { "tag": "gothic_dress",     "ja": "ゴシックドレス（セクシー）","level": "L1" },
      { "tag": "lolita_dress_r18", "ja": "ロリータ服（えっち仕様）","level": "L2" },
      { "tag": "latex_bodysuit",   "ja": "ラテックス全身スーツ",   "level": "L2" },
      { "tag": "mesh_outfit",      "ja": "メッシュ衣装",           "level": "L2" },
    ...
    "underwear": [
      ...
      { "tag": "kimono_underwear",    "ja": "和風下着（着物用）",   "level": "L1" },
      { "tag": "miko_underwear",      "ja": "巫女下着（えっち仕様）","level": "L1" },
      { "tag": "feather_bra",         "ja": "羽ブラ",              "level": "L2" },
      { "tag": "chain_panties",       "ja": "チェーンパンツ",      "level": "L2" },
      { "tag": "crystal_lingerie",    "ja": "クリスタル下着",      "level": "L2" },
      { "tag": "armor_lingerie",      "ja": "鎧風下着",            "level": "L2" },
      { "tag": "glowing_lingerie",    "ja": "発光ランジェリー",    "level": "L3" },
      { "tag": "liquid_lingerie",     "ja": "液体下着",            "level": "L3" }
    ],
        "body": [
