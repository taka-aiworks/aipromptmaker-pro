...
function buildOneLearning(extraSeed = 0){
  ...
  // 7) NSFW 追加分
  const addonRaw = (typeof getSelectedNSFW_Learn === 'function' ? (getSelectedNSFW_Learn()||[]) : []);
  const addon = addonRaw.map(norm);
